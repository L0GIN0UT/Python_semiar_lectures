...
def choose():
    while True:
        ...
        if choise == '2': return read_search(input('Внимание: Если введете Фамилию.\nПрограмма покажет всех Однофамильцев\nВведите Фамилию или ID человека которого вы ищите -> '))
